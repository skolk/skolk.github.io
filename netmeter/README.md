...
- **Recent usage**, at the bottom of the menu: who has spent the data over the last 5m / 15m / 1h / 6h / 12h, ranked, with a bar for each app's share. Daily totals cannot answer this, because they only ever go up: they tell you who has spent the most since midnight, never who is spending it *now*. Click the window you want; the chevron on the left collapses the section when you don't want the height. Both the window and the collapsed state persist.
