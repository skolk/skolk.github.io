...
layout: post
type: trip-report
title: Sailing to Alaska on Petrichor
subtitle: "Sailing to Alaska on Petrichor"
date: 2026-05-15 00:00:00
categories: [sailing, alaska, inside-passage, cruising, trip-report]
tags: [sailing, cruising, needs-expansion]
place: "Inside Passage to Southeast Alaska"
region: "Pacific Northwest"
reviewed_by_sean: false
short_description: A long Inside Passage run on Petrichor, Shilshole to Southeast Alaska. A long blog in itself, stub for now.
---
...
The route, broadly, runs out of Shilshole, north through the San Juans and into Canadian waters, up the Inside Passage of British Columbia (Desolation Sound, Johnstone Strait, the Broughtons, then around Cape Caution and the long open stretch up the BC mid-coast), into Southeast Alaska through Dixon Entrance, and then north into the Alexander Archipelago. The choices from there branch: north into the icefields, west toward Sitka and the outer coast, or up Lynn Canal toward Skagway. Each branch is its own trip.
...
- The communities. Petersburg, Wrangell, Sitka, Hoonah, Gustavus. The people who live there year round and the boats that come through.

Coming back to this one. A lot of notebook pages and a lot of memory to translate into words. Until then, here's the placeholder.
