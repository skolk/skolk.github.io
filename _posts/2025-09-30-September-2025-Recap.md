...
**Astraeus.** Shellfish one-pager push. Meeting with Brady Brown on three Naval Research BAA proposals: X-PARS swarm passive acoustic, single-beam down sounder, DARPA. Deal with Drayton Harbor Oyster Co. Taylor Shellfish in pipeline.
...
**Corumat (Mike Waggoner).** CRM build-out. Outreach push to Kellanova (Jennifer Hebets), Trident Seafood (Senya Joerss), Microsoft (Katie Ross), Mars (Paola). Attended the Carbonaughts event. Structured contract at $75 an hour plus 5 percent trust on investors plus 10 percent commission.

**REAP.** Officially stepped back. Left REAP and didn't feel like a total jerk. Still getting paid.
