(() => {
  ...
  const STARTING_RURAL = {
    ...
    // produces food
    materials: 80,
    // produces water, timber, ecosystem services
    population: 1200,
    cohesion: 70,
    // social fabric
    // Needs from the other side
    capital: 20,
    // low: starved of investment
    healthAccess: 35,
    // low: clinics are thin
    marketAccess: 40,
    // low: hard to sell what they grow
    knowledgeIn: 30,
    // low: brain drain
    // Disposition
    trust: 40,
    // trust toward the urban side
    voice: 50,
    // feeling of being heard
    patience: 70,
    // willingness to wait for a deal to pay off
    memory: 80,
    // long memory of broken promises
  ...
  const STARTING_URBAN = {
    ...
    materials: 35,
    ecosystem: 30,
    // carbon, water buffering, biodiversity
    labor: 40,
    // Disposition
    trust: 45,
    voice: 60,
    // urban tends to feel its voice is the default voice
    patience: 35,
    // shorter time horizon
    memory: 35,
    // forgets agreements quickly
  ...
  const INSTITUTIONS = {
    watershed_council: {
      ...
      tier: 1,
      lineage: "Ostrom \xB7 Spanish huertas, Maine lobster gangs"
    },
    food_hub: {
      ...
      tier: 1,
      lineage: "Raj Patel \xB7 Cuban organop\xF3nicos \xB7 Hardwick VT"
    },
    knowledge_exchange: {
      ...
      tier: 1,
      lineage: "James Scott \xB7 Indy Johar \xB7 Donella Meadows"
    },
    regional_bank: {
      name: "Regional Bank",
      ...
      tier: 2,
      lineage: "Hausmann \xB7 cooperative finance \xB7 land trusts"
    },
    health_circuit: {
      ...
      tier: 2,
      lineage: "Esther Duflo \xB7 Cuban family medicine"
    },
    carbon_compact: {
      ...
      tier: 3,
      lineage: "Astraeus framing \xB7 nature-based MRV \xB7 stewardship payments"
    }
  };
  const SHOCKS = {
    drought: {
  ...
  function resolveTurn(state, facilitatorChoice) {
    ...
    if (s.pendingInstitution) {
      const inst2 = INSTITUTIONS[s.pendingInstitution];
      ...
      if (rChoice === "C" && uChoice === "C") {
        ...
        events.push({ tone: "good", text: `${inst2.name} is built. Both councils participated in the founding.` });
        s.history = [...s.history, { turn: s.turn, type: "institution_built", which: s.pendingInstitution }];
        institutionOutcome = { key: s.pendingInstitution, name: inst2.name, built: true };
      } else {
        s.rural = { ...s.rural, trust: Math.max(0, s.rural.trust - 4) };
        s.urban = { ...s.urban, trust: Math.max(0, s.urban.trust - 4) };
        events.push({ tone: "bad", text: `${inst2.name} did not come together. One or both sides held back at the table.` });
        institutionOutcome = { key: s.pendingInstitution, name: inst2.name, built: false, ruralChoice: rChoice, urbanChoice: uChoice };
      }
      s.pendingInstitution = null;
    }
    s.activeAgreements = s.activeAgreements.map((a) => {
    ...
    s.urban.trust = Math.max(0, s.urban.trust - 1);
  ...
  const S = {
    page: {
      ...
      minHeight: "100vh",
      background: "#d8dcb5",
      backgroundImage: "radial-gradient(circle at 18% 12%, rgba(94, 133, 51, 0.14) 0px, transparent 50%),radial-gradient(circle at 82% 88%, rgba(47, 86, 112, 0.10) 0px, transparent 50%),radial-gradient(circle at 50% 50%, rgba(181, 108, 58, 0.06) 0px, transparent 60%)",
  ...
  function VillageScene({ color, accent, deep }) {
    return /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 120 50", width: "100%", height: "56", style: { display: "block" } }, /* @__PURE__ */ React.createElement("circle", { cx: "100", cy: "12", r: "6", fill: "#f0c14a", opacity: "0.75" }), /* @__PURE__ */ React.createElement("path", { d: "M 0 38 Q 25 28 50 32 T 120 30 L 120 50 L 0 50 Z", fill: deep, opacity: "0.25" }), /* @__PURE__ */ React.createElement("path", { d: "M 0 42 Q 30 40 60 42 T 120 41", stroke: accent, strokeWidth: "0.6", fill: "none", opacity: "0.4" }), /* @__PURE__ */ React.createElement("path", { d: "M 0 45 Q 30 43 60 45 T 120 44", stroke: accent, strokeWidth: "0.6", fill: "none", opacity: "0.4" }), /* @__PURE__ */ React.createElement("g", { transform: "translate(20, 28)" }, /* @__PURE__ */ React.createElement("path", { d: "M 0 8 L 0 4 L 5 0 L 10 4 L 10 8 Z", fill: "#b87a4a", stroke: deep, strokeWidth: "0.5" }), /* @__PURE__ */ React.createElement("rect", { x: "3.5", y: "4.5", width: "3", height: "3.5", fill: "#5a3a1a" }), /* @__PURE__ */ React.createElement("path", { d: "M -1 4 L 5 -1 L 11 4", stroke: deep, strokeWidth: "0.6", fill: "none" })), /* @__PURE__ */ React.createElement("g", { transform: "translate(45, 28)", className: "sway" }, /* @__PURE__ */ React.createElement("rect", { x: "2.5", y: "6", width: "1.2", height: "4", fill: "#6a4a2a" }), /* @__PURE__ */ React.createElement("circle", { cx: "3", cy: "5", r: "4", fill: accent }), /* @__PURE__ */ React.createElement("circle", { cx: "5", cy: "4", r: "3", fill: color }), /* @__PURE__ */ React.createElement("circle", { cx: "1.5", cy: "4.5", r: "2.8", fill: color })), /* @__PURE__ */ React.createElement("g", { transform: "translate(70, 26)" }, /* @__PURE__ */ React.createElement("rect", { x: "0", y: "4", width: "12", height: "8", fill: "#a23a1a", opacity: "0.85", stroke: deep, strokeWidth: "0.5" }), /* @__PURE__ */ React.createElement("path", { d: "M -1 4 L 6 -1 L 13 4", fill: "#7a2a10", stroke: deep, strokeWidth: "0.5" }), /* @__PURE__ */ React.createElement("line", { x1: "6", y1: "-1", x2: "6", y2: "12", stroke: deep, strokeWidth: "0.3" })), /* @__PURE__ */ React.createElement("g", { transform: "translate(88, 38)" }, /* @__PURE__ */ React.createElement("line", { x1: "0", y1: "0", x2: "0", y2: "4", stroke: color, strokeWidth: "0.5" }), /* @__PURE__ */ React.createElement("line", { x1: "2", y1: "0", x2: "2", y2: "4", stroke: color, strokeWidth: "0.5" }), /* @__PURE__ */ React.createElement("line", { x1: "4", y1: "0", x2: "4", y2: "4", stroke: color, strokeWidth: "0.5" }), /* @__PURE__ */ React.createElement("circle", { cx: "0", cy: "0", r: "0.8", fill: "#d4a45a" }), /* @__PURE__ */ React.createElement("circle", { cx: "2", cy: "0", r: "0.8", fill: "#d4a45a" }), /* @__PURE__ */ React.createElement("circle", { cx: "4", cy: "0", r: "0.8", fill: "#d4a45a" })));
  }
  function CityScene({ color, accent, deep }) {
    return /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 120 50", width: "100%", height: "56", style: { display: "block" } }, /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement("linearGradient", { id: "citysky", x1: "0", y1: "0", x2: "0", y2: "1" }, /* @__PURE__ */ React.createElement("stop", { offset: "0%", stopColor: "#dbc89a", stopOpacity: "0.3" }), /* @__PURE__ */ React.createElement("stop", { offset: "100%", stopColor: "#a8b4a8", stopOpacity: "0.1" }))), /* @__PURE__ */ React.createElement("rect", { x: "0", y: "0", width: "120", height: "50", fill: "url(#citysky)" }), /* @__PURE__ */ React.createElement("rect", { x: "0", y: "36", width: "120", height: "14", fill: deep, opacity: "0.15" }), /* @__PURE__ */ React.createElement("g", { fill: deep }, /* @__PURE__ */ React.createElement("rect", { x: "8", y: "24", width: "9", height: "20" }), /* @__PURE__ */ React.createElement("rect", { x: "20", y: "18", width: "11", height: "26" }), /* @__PURE__ */ React.createElement("rect", { x: "34", y: "14", width: "8", height: "30" }), /* @__PURE__ */ React.createElement("rect", { x: "45", y: "22", width: "10", height: "22" }), /* @__PURE__ */ React.createElement("rect", { x: "58", y: "10", width: "9", height: "34" }), /* @__PURE__ */ React.createElement("rect", { x: "70", y: "16", width: "12", height: "28" }), /* @__PURE__ */ React.createElement("rect", { x: "85", y: "20", width: "9", height: "24" }), /* @__PURE__ */ React.createElement("rect", { x: "97", y: "14", width: "10", height: "30" }), /* @__PURE__ */ React.createElement("rect", { x: "110", y: "22", width: "8", height: "22" })), /* @__PURE__ */ React.createElement("g", { fill: accent, opacity: "0.45" }, /* @__PURE__ */ React.createElement("rect", { x: "20", y: "18", width: "11", height: "3" }), /* @__PURE__ */ React.createElement("rect", { x: "34", y: "14", width: "8", height: "3" }), /* @__PURE__ */ React.createElement("rect", { x: "58", y: "10", width: "9", height: "3" }), /* @__PURE__ */ React.createElement("rect", { x: "97", y: "14", width: "10", height: "3" })), /* @__PURE__ */ React.createElement("g", { fill: "#f6d18a", opacity: "0.85" }, /* @__PURE__ */ React.createElement("rect", { x: "10", y: "28", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "13", y: "28", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "22", y: "22", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "25", y: "26", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "22", y: "30", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "36", y: "20", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "39", y: "24", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "60", y: "14", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "63", y: "18", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "60", y: "22", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "72", y: "20", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "76", y: "24", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "99", y: "18", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "102", y: "22", width: "1.2", height: "1.2" }), /* @__PURE__ */ React.createElement("rect", { x: "113", y: "26", width: "1.2", height: "1.2" })), /* @__PURE__ */ React.createElement("g", { stroke: deep, strokeWidth: "0.5", fill: "none" }, /* @__PURE__ */ React.createElement("line", { x1: "78", y1: "8", x2: "78", y2: "22" }), /* @__PURE__ */ React.createElement("line", { x1: "74", y1: "10", x2: "88", y2: "10" }), /* @__PURE__ */ React.createElement("line", { x1: "78", y1: "8", x2: "80", y2: "9.5" }), /* @__PURE__ */ React.createElement("line", { x1: "82", y1: "10", x2: "82", y2: "13" })));
  }
  function Bridge() {
    return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", margin: "12px 0 14px", gap: 8 } }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 200 26", width: "100%", height: "26", style: { maxWidth: 300 } }, /* @__PURE__ */ React.createElement("path", { d: "M 10 22 Q 100 -4 190 22", stroke: colors.facilitatorDeep, strokeWidth: "1.2", fill: "none" }), /* @__PURE__ */ React.createElement("path", { d: "M 10 22 Q 100 0 190 22", stroke: colors.facilitator, strokeWidth: "0.8", fill: "none", opacity: "0.55" }), /* @__PURE__ */ React.createElement("line", { x1: "10", y1: "22", x2: "10", y2: "26", stroke: colors.facilitatorDeep, strokeWidth: "1.5" }), /* @__PURE__ */ React.createElement("line", { x1: "190", y1: "22", x2: "190", y2: "26", stroke: colors.facilitatorDeep, strokeWidth: "1.5" }), /* @__PURE__ */ React.createElement("circle", { cx: "100", cy: "5", r: "1.5", fill: colors.facilitator }), /* @__PURE__ */ React.createElement("line", { x1: "100", y1: "6.5", x2: "100", y2: "10", stroke: colors.facilitator, strokeWidth: "1" }), /* @__PURE__ */ React.createElement("circle", { cx: "55", cy: "12", r: "0.8", fill: colors.facilitator, opacity: "0.4" }), /* @__PURE__ */ React.createElement("circle", { cx: "145", cy: "12", r: "0.8", fill: colors.facilitator, opacity: "0.4" })));
  }
  function CompassMark() {
    return /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 30 30", width: "22", height: "22", style: { display: "inline-block", verticalAlign: "middle" } }, /* @__PURE__ */ React.createElement("circle", { cx: "15", cy: "15", r: "12", fill: "none", stroke: colors.facilitatorDeep, strokeWidth: "1.2" }), /* @__PURE__ */ React.createElement("circle", { cx: "15", cy: "15", r: "2", fill: colors.facilitatorDeep }), /* @__PURE__ */ React.createElement("path", { d: "M 15 4 L 17 14 L 15 16 L 13 14 Z", fill: colors.facilitator }), /* @__PURE__ */ React.createElement("path", { d: "M 15 26 L 13 16 L 15 14 L 17 16 Z", fill: colors.facilitatorBg, stroke: colors.facilitatorDeep, strokeWidth: "0.5" }));
  }
  function CapacityBar({ label, value, max = 100, color }) {
    const pct = Math.min(100, Math.max(0, value / max * 100));
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: S.capacityRow }, /* @__PURE__ */ React.createElement("span", { style: S.capacityLabel }, label), /* @__PURE__ */ React.createElement("span", { style: S.capacityVal }, value.toFixed(0))), /* @__PURE__ */ React.createElement("div", { style: S.capacityBar }, /* @__PURE__ */ React.createElement("div", { style: { ...S.capacityBarFill, width: `${pct}%`, background: color } })));
  }
  function CouncilCard({ council, voice, isRural }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { ...S.council, background: bg, borderColor: border }, className: "fadein" }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 8, marginLeft: -12, marginRight: -12, marginTop: -12, padding: "8px 12px 4px", background: "rgba(255,255,255,0.35)", borderTopLeftRadius: 8, borderTopRightRadius: 8 } }, isRural ? /* @__PURE__ */ React.createElement(VillageScene, { color: border, accent, deep }) : /* @__PURE__ */ React.createElement(CityScene, { color: border, accent, deep })), /* @__PURE__ */ React.createElement("div", { style: S.councilHeader }, /* @__PURE__ */ React.createElement("span", { style: S.councilIcon }, council.icon), /* @__PURE__ */ React.createElement("span", { style: { ...S.councilName, color: deep } }, council.name), /* @__PURE__ */ React.createElement("span", { style: S.councilKind }, council.kind)), /* @__PURE__ */ React.createElement("div", { style: { ...S.sectionLabel, ...S.sectionLabelFirst } }, /* @__PURE__ */ React.createElement("span", { style: { ...S.dotMark, background: accent } }), "What they have"), isRural ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(CapacityBar, { label: "Food production", value: council.food, color: accent }), /* @__PURE__ */ React.createElement(CapacityBar, { label: "Materials & water", value: council.materials, color: accent }), /* @__PURE__ */ React.createElement(CapacityBar, { label: "Cohesion", value: council.cohesion, color: accent })) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(CapacityBar, { label: "Capital", value: council.capital, color: accent }), /* @__PURE__ */ React.createElement(CapacityBar, { label: "Manufactured", value: council.manufactured, color: accent }), /* @__PURE__ */ React.createElement(CapacityBar, { label: "Cohesion", value: council.cohesion, color: accent })), /* @__PURE__ */ React.createElement("div", { style: S.sectionLabel }, /* @__PURE__ */ React.createElement("span", { style: { ...S.dotMark, background: colors.warn } }), "What they need"), isRural ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(CapacityBar, { label: "Capital access", value: council.capital, color: colors.warn }), /* @__PURE__ */ React.createElement(CapacityBar, { label: "Market access", value: council.marketAccess, color: colors.warn }), /* @__PURE__ */ React.createElement(CapacityBar, { label: "Healthcare", value: council.healthAccess, color: colors.warn })) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(CapacityBar, { label: "Food security", value: council.food, color: colors.warn }), /* @__PURE__ */ React.createElement(CapacityBar, { label: "Materials supply", value: council.materials, color: colors.warn }), /* @__PURE__ */ React.createElement(CapacityBar, { label: "Ecosystem services", value: council.ecosystem, color: colors.warn })), /* @__PURE__ */ React.createElement("div", { style: S.sectionLabel }, /* @__PURE__ */ React.createElement("span", { style: { ...S.dotMark, background: deep } }), "Disposition"), /* @__PURE__ */ React.createElement(CapacityBar, { label: `Trust \u2192 ${isRural ? "Urban" : "Rural"}`, value: council.trust, color: border }), /* @__PURE__ */ React.createElement(CapacityBar, { label: "Feels heard", value: council.voice, color: border }), voice && /* @__PURE__ */ React.createElement("div", { style: S.voiceBlock }, /* @__PURE__ */ React.createElement("div", { style: S.voiceLabel }, council.name, " says..."), /* @__PURE__ */ React.createElement("div", { style: S.voiceLine }, /* @__PURE__ */ React.createElement("span", { style: { ...S.voiceLineGlyph, color: deep } }, "\u25C6"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("strong", { style: { color: deep, fontFamily: "Georgia, 'Times New Roman', serif" } }, "Position."), " ", voice.position)), /* @__PURE__ */ React.createElement("div", { style: S.voiceLine }, /* @__PURE__ */ React.createElement("span", { style: { ...S.voiceLineGlyph, color: colors.warn } }, "\u26A0"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("strong", { style: { color: colors.warn, fontFamily: "Georgia, 'Times New Roman', serif" } }, "Fear."), " ", voice.fear)), /* @__PURE__ */ React.createElement("div", { style: S.voiceLine }, /* @__PURE__ */ React.createElement("span", { style: { ...S.voiceLineGlyph, color: colors.facilitatorDeep } }, "\u2726"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("strong", { style: { color: colors.facilitatorDeep, fontFamily: "Georgia, 'Times New Roman', serif" } }, "Ask."), " ", voice.ask))));
  }
  function MatrixCell({ value, isHighlight }) {
    return /* @__PURE__ */ React.createElement("div", { style: { ...S.matrixCell, background: isHighlight ? "#fce8c8" : "#eee9c4", ...isHighlight ? S.matrixCellHighlight : {} } }, /* @__PURE__ */ React.createElement("div", { style: S.matrixCellVal }, /* @__PURE__ */ React.createElement("span", { style: { color: colors.ruralDeep } }, value.rural >= 0 ? "+" : "", value.rural.toFixed(0)), /* @__PURE__ */ React.createElement("span", { style: { color: colors.inkSoft, margin: "0 4px" } }, "/"), /* @__PURE__ */ React.createElement("span", { style: { color: colors.urbanDeep } }, value.urban >= 0 ? "+" : "", value.urban.toFixed(0))), /* @__PURE__ */ React.createElement("div", { style: S.matrixCellLabel }, value.label));
  }
  function PayoffMatrix({ payoff, predictedR, predictedU }) {
    const predictedCell = `${predictedR}${predictedU}`;
    return /* @__PURE__ */ React.createElement("div", { style: S.matrixSection }, /* @__PURE__ */ React.createElement("div", { style: S.matrixHeader }, /* @__PURE__ */ React.createElement("span", { style: S.matrixTitle }, "Payoff this turn"), /* @__PURE__ */ React.createElement("span", { style: S.matrixSub }, "rural / urban")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: colors.inkSoft, marginBottom: 4, lineHeight: 1.5, fontFamily: "Georgia, 'Times New Roman', serif" } }, "Each cell is what each side gains or loses. Their actual choice blends payoff with trust, memory, and how heard they feel.", predictedR && predictedU && /* @__PURE__ */ React.createElement(React.Fragment, null, " The bordered cell is what each side will likely pick.")), /* @__PURE__ */ React.createElement("div", { style: S.matrix }, /* @__PURE__ */ React.createElement("div", { style: S.matrixCorner }), /* @__PURE__ */ React.createElement("div", { style: { ...S.matrixColHeader, color: colors.urbanDeep } }, "Urban", /* @__PURE__ */ React.createElement("br", null), "cooperates"), /* @__PURE__ */ React.createElement("div", { style: { ...S.matrixColHeader, color: colors.urbanDeep } }, "Urban", /* @__PURE__ */ React.createElement("br", null), "defects"), /* @__PURE__ */ React.createElement("div", { style: { ...S.matrixRowHeader, color: colors.ruralDeep } }, "Rural", /* @__PURE__ */ React.createElement("br", null), "cooperates"), /* @__PURE__ */ React.createElement(MatrixCell, { value: payoff.CC, isHighlight: predictedCell === "CC" }), /* @__PURE__ */ React.createElement(MatrixCell, { value: payoff.CD, isHighlight: predictedCell === "CD" }), /* @__PURE__ */ React.createElement("div", { style: { ...S.matrixRowHeader, color: colors.ruralDeep } }, "Rural", /* @__PURE__ */ React.createElement("br", null), "defects"), /* @__PURE__ */ React.createElement(MatrixCell, { value: payoff.DC, isHighlight: predictedCell === "DC" }), /* @__PURE__ */ React.createElement(MatrixCell, { value: payoff.DD, isHighlight: predictedCell === "DD" })));
  }
  ...
  function CopyLogButton({ state }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { marginTop: 18, padding: 12, background: "rgba(232, 231, 196, 0.45)", borderRadius: 8, border: `1px dashed ${colors.cardEdge}` } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 13, fontWeight: 700, color: colors.facilitatorDeep, marginBottom: 8 } }, "Share this playtest"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: colors.inkSoft, marginBottom: 10, lineHeight: 1.5, fontFamily: "Georgia, 'Times New Roman', serif" } }, "Copies the full game state, institutions built, shocks weathered, and turn-by-turn log. Paste it back to Sean to share what you saw."), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: handleClick,
        style: {
    ...
    ), status === "showing" && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: colors.inkSoft, marginBottom: 6, fontFamily: "Georgia, 'Times New Roman', serif" } }, "Clipboard access didn't work \u2014 tap and hold below to select all, then copy."), /* @__PURE__ */ React.createElement(
      "textarea",
      {
        readOnly: true,
        value: text,
  ...
  function LastTurnCard({ summary, scenarioName }) {
    ...
    const Stat = ({ label, deltaR, deltaU }) => /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "4px 0", borderTop: `1px dotted ${colors.divider}`, fontSize: 13 } }, /* @__PURE__ */ React.createElement("span", { style: { color: colors.inkSoft, fontFamily: "Georgia, 'Times New Roman', serif" } }, label), /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { color: colors.ruralDeep, fontWeight: 600, fontSize: 12 } }, "\u{1F33E}"), /* @__PURE__ */ React.createElement(Delta, { value: deltaR }), /* @__PURE__ */ React.createElement("span", { style: { color: colors.urbanDeep, fontWeight: 600, fontSize: 12, marginLeft: 10 } }, "\u{1F3D9}"), /* @__PURE__ */ React.createElement(Delta, { value: deltaU })));
    return /* @__PURE__ */ React.createElement("div", { style: {
      ...
      marginBottom: 14,
      boxShadow: "2px 3px 0 rgba(0,0,0,0.06)"
    } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, letterSpacing: "0.16em", color: colors.facilitatorDeep, textTransform: "uppercase", fontWeight: 700, marginBottom: 8, fontFamily: "Georgia, 'Times New Roman', serif" } }, "What just happened \xB7 turn ", summary.turn), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, marginBottom: 8, fontFamily: "Georgia, 'Times New Roman', serif", lineHeight: 1.45 } }, /* @__PURE__ */ React.createElement("strong", { style: { color: colors.facilitatorDeep } }, "You:"), " ", moveLabel, "."), outcomeLine && /* @__PURE__ */ React.createElement("div", { style: {
      fontSize: 14,
      marginBottom: 8,
      padding: "8px 10px",
      ...
      fontFamily: "Georgia, 'Times New Roman', serif",
      lineHeight: 1.4
    } }, outcomeLine.text), shockText && /* @__PURE__ */ React.createElement("div", { style: {
      fontSize: 14,
      marginBottom: 8,
      padding: "8px 10px",
      ...
      fontFamily: "Georgia, 'Times New Roman', serif",
      lineHeight: 1.4
    } }, shockText), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, paddingTop: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, letterSpacing: "0.14em", color: colors.inkSoft, textTransform: "uppercase", fontWeight: 700, marginBottom: 2, fontFamily: "Georgia, 'Times New Roman', serif" } }, "Net change this turn"), /* @__PURE__ */ React.createElement(Stat, { label: "Trust", deltaR: dr.trust, deltaU: du.trust }), /* @__PURE__ */ React.createElement(Stat, { label: "Voice (feels heard)", deltaR: dr.voice, deltaU: du.voice }), /* @__PURE__ */ React.createElement(Stat, { label: "Cohesion", deltaR: dr.cohesion, deltaU: du.cohesion }), /* @__PURE__ */ React.createElement(Stat, { label: "Food", deltaR: dr.food, deltaU: du.food })));
  }
  function ScenarioPicker({ onStart }) {
    const [hovered, setHovered] = useState(null);
    return /* @__PURE__ */ React.createElement("div", { style: S.page }, /* @__PURE__ */ React.createElement("header", { style: S.header }, /* @__PURE__ */ React.createElement("div", { style: S.eyebrow }, "A facilitator's game \xB7 iterated coordination \xB7 ", VERSION), /* @__PURE__ */ React.createElement("h1", { style: S.h1 }, "The Facilitator"), /* @__PURE__ */ React.createElement("div", { style: S.sub }, "two communities, one mediator, twenty turns of weather")), /* @__PURE__ */ React.createElement(Bridge, null), /* @__PURE__ */ React.createElement("div", { style: S.intro }, /* @__PURE__ */ React.createElement("p", { style: S.introP }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 19, color: colors.facilitatorDeep, lineHeight: 1, display: "block", marginBottom: 6 } }, "You arrive as a stranger."), "You don't run either community. You sit between them. They've been warily neighboring each other for as long as anyone remembers, and you're here to see if that can change."), /* @__PURE__ */ React.createElement("p", { style: S.introP }, "Each turn you act, a shock lands, and each side decides whether to cooperate or defect on whatever's on the table. They decide using the payoff matrix, but also trust, recent betrayal, and whether they feel heard. ", /* @__PURE__ */ React.createElement("span", { style: S.thinker }, "Schelling \xB7 Ostrom \xB7 Axelrod")), /* @__PURE__ */ React.createElement("p", { style: S.introP }, "Your tools: translation, trade, multi-turn agreements, shared institutions, mediation. Institutions are slow, expensive, and they change the matrix itself.")), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 16, fontWeight: 700, letterSpacing: "-0.01em", marginBottom: 4, marginTop: 18, color: colors.ink } }, "Choose a starting situation"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 16, color: colors.facilitatorDeep, marginBottom: 12 } }, "each one tilts the game differently"), Object.entries(SCENARIOS).map(([key, sc]) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key,
        onClick: () => onStart(key),
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 26 } }, sc.glyph), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 18, fontWeight: 700, letterSpacing: "-0.01em" } }, sc.name)),
      /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 17, color: colors.facilitatorDeep, marginBottom: 6, lineHeight: 1.3 } }, sc.tagline),
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: colors.inkSoft, lineHeight: 1.5 } }, sc.detail),
      /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, padding: "6px 8px", background: "rgba(94, 133, 51, 0.08)", borderRadius: 6, fontSize: 11, color: colors.inkSoft } }, /* @__PURE__ */ React.createElement("span", { style: { color: colors.ruralDeep, fontWeight: 700 } }, "\u{1F33E} trust ", sc.rural.trust), /* @__PURE__ */ React.createElement("span", { style: { margin: "0 8px", color: colors.divider } }, "\xB7"), /* @__PURE__ */ React.createElement("span", { style: { color: colors.urbanDeep, fontWeight: 700 } }, "\u{1F3D9} trust ", sc.urban.trust), /* @__PURE__ */ React.createElement("span", { style: { margin: "0 8px", color: colors.divider } }, "\xB7"), /* @__PURE__ */ React.createElement("span", null, "capital rural ", sc.rural.capital, " / urban ", sc.urban.capital))
    )), /* @__PURE__ */ React.createElement("p", { style: { ...S.introP, padding: "10px 12px", background: "rgba(181,108,58,0.08)", borderRadius: 6, borderLeft: `3px solid ${colors.facilitator}`, marginTop: 14, fontSize: 13 } }, /* @__PURE__ */ React.createElement("strong", { style: { fontFamily: "Georgia, 'Times New Roman', serif", color: colors.facilitatorDeep } }, "To win:"), " 20 turns, both sides standing, trust climbing, four institutions or more.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("strong", { style: { fontFamily: "Georgia, 'Times New Roman', serif", color: colors.facilitatorDeep } }, "To lose:"), " either side collapses, or trust hits zero on both."));
  }
  function EndScreen({ result, state, onReset }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: S.page }, /* @__PURE__ */ React.createElement("div", { style: S.endScreen }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 48, marginBottom: 10, color }, className: "stamp-in" }, glyph), /* @__PURE__ */ React.createElement("div", { style: { ...S.eyebrow, color } }, result.type === "win" ? "the work held" : result.type === "loss" ? "collapse" : "time ran out"), /* @__PURE__ */ React.createElement("h1", { style: { ...S.endTitle, color } }, result.type === "win" ? "The region holds." : result.type === "loss" ? "The relationship broke." : "Unfinished work."), /* @__PURE__ */ React.createElement("p", { style: S.endText }, result.text), /* @__PURE__ */ React.createElement("div", { style: { background: colors.card, border: `2px solid ${colors.cardEdge}`, padding: 16, borderRadius: 10, textAlign: "left", marginBottom: 16, boxShadow: "2px 3px 0 rgba(0,0,0,0.06)" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 13, fontWeight: 700, letterSpacing: "-0.01em", marginBottom: 10 } }, "Final state"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, lineHeight: 1.9, fontFamily: "Georgia, 'Times New Roman', serif" } }, /* @__PURE__ */ React.createElement("div", null, "Turn reached: ", /* @__PURE__ */ React.createElement("strong", { className: "num" }, state.turn)), /* @__PURE__ */ React.createElement("div", null, "Trust average: ", /* @__PURE__ */ React.createElement("strong", { className: "num" }, trustAvg, "/100")), /* @__PURE__ */ React.createElement("div", null, "Institutions built: ", /* @__PURE__ */ React.createElement("strong", { className: "num" }, institutionsBuilt)), /* @__PURE__ */ React.createElement("div", null, "Shocks weathered: ", /* @__PURE__ */ React.createElement("strong", { className: "num" }, state.shockHistory.length)), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, paddingTop: 10, borderTop: `1px dashed ${colors.divider}` } }, /* @__PURE__ */ React.createElement("span", { style: { color: colors.ruralDeep } }, "\u{1F33E} ", r.name), " cohesion ", /* @__PURE__ */ React.createElement("strong", { className: "num" }, r.cohesion.toFixed(0)), " \xB7 food ", /* @__PURE__ */ React.createElement("strong", { className: "num" }, r.food.toFixed(0))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { color: colors.urbanDeep } }, "\u{1F3D9} ", u.name), " cohesion ", /* @__PURE__ */ React.createElement("strong", { className: "num" }, u.cohesion.toFixed(0)), " \xB7 food ", /* @__PURE__ */ React.createElement("strong", { className: "num" }, u.food.toFixed(0))))), /* @__PURE__ */ React.createElement("div", { style: { background: colors.facilitatorBg, border: `2px solid ${colors.facilitator}`, padding: 16, borderRadius: 10, textAlign: "left", marginBottom: 20, boxShadow: "2px 3px 0 rgba(125,63,31,0.18)" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 13, fontWeight: 700, color: colors.facilitatorDeep, marginBottom: 10, letterSpacing: "-0.01em" } }, "Reflection"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 18, lineHeight: 1.45, color: colors.facilitatorDeep } }, "Which moves built durable trust versus produced one-turn gains? Did you build institutions early enough to absorb the shocks that came? When one side was speaking, did you hear what they were actually asking for?")), /* @__PURE__ */ React.createElement("button", { onClick: onReset, style: S.resetBtn }, "Play again \u203A"), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 20 } }, /* @__PURE__ */ React.createElement(CopyLogButton, { state }))));
  }
  function App() {
    const [state, setState] = useState(null);
    const [selectedMove, setSelectedMove] = useState(null);
    const [pickingInstitution, setPickingInstitution] = useState(false);
    if (!state) return /* @__PURE__ */ React.createElement(ScenarioPicker, { onStart: (key) => setState(initialState(key)) });
    if (state.gameOver) return /* @__PURE__ */ React.createElement(EndScreen, { result: state.gameOver, state, onReset: () => {
      setState(null);
    ...
    return /* @__PURE__ */ React.createElement("div", { style: S.page }, /* @__PURE__ */ React.createElement("header", { style: S.header }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 } }, /* @__PURE__ */ React.createElement("div", { style: S.eyebrow }, SCENARIOS[state.scenarioKey].glyph, " ", SCENARIOS[state.scenarioKey].name, " \xB7 turn ", state.turn, " of 20 \xB7 ", VERSION), /* @__PURE__ */ React.createElement(CompassMark, null)), /* @__PURE__ */ React.createElement("h1", { style: S.h1 }, "Between ", state.rural.name, " & ", state.urban.name), /* @__PURE__ */ React.createElement("div", { style: S.sub }, "read them, translate, broker, build what changes the matrix"), /* @__PURE__ */ React.createElement("div", { style: S.turnRow }, /* @__PURE__ */ React.createElement("span", null, "trust ", /* @__PURE__ */ React.createElement("span", { style: { color: colors.ruralDeep, fontWeight: 700 } }, "\u{1F33E} ", /* @__PURE__ */ React.createElement("span", { className: "num" }, state.rural.trust.toFixed(0))), /* @__PURE__ */ React.createElement("span", { style: { margin: "0 6px", color: colors.divider } }, "\xB7"), /* @__PURE__ */ React.createElement("span", { style: { color: colors.urbanDeep, fontWeight: 700 } }, "\u{1F3D9} ", /* @__PURE__ */ React.createElement("span", { className: "num" }, state.urban.trust.toFixed(0)))), /* @__PURE__ */ React.createElement("span", { style: S.energyBlock }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: colors.facilitatorDeep, fontWeight: 700, marginRight: 4 } }, "energy"), [...Array(8)].map((_, i) => /* @__PURE__ */ React.createElement("span", { key: i, style: i < state.facilitatorEnergy ? S.energyDot : S.energyEmpty }))))), state.lastTurnSummary && /* @__PURE__ */ React.createElement(LastTurnCard, { summary: state.lastTurnSummary }), /* @__PURE__ */ React.createElement("div", { style: S.councilsRow }, /* @__PURE__ */ React.createElement(CouncilCard, { council: state.rural, voice: ruralLines, isRural: true }), /* @__PURE__ */ React.createElement(CouncilCard, { council: state.urban, voice: urbanLines, isRural: false })), /* @__PURE__ */ React.createElement("div", { style: S.institutionsRow }, /* @__PURE__ */ React.createElement("div", { style: S.institutionsHeader }, /* @__PURE__ */ React.createElement("span", null, "Shared institutions"), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 17, color: colors.facilitatorDeep } }, state.institutions.length === 0 ? "none yet" : `${state.institutions.length} built`)), state.institutions.length === 0 ? /* @__PURE__ */ React.createElement("span", { style: S.institutionChipEmpty }, "nothing shared yet \u2014 each shock will be faced alone") : state.institutions.map((k) => /* @__PURE__ */ React.createElement("span", { key: k, style: S.institutionChip, className: "stamp-in" }, /* @__PURE__ */ React.createElement("span", { style: { color: colors.facilitator } }, "\u2726"), " ", INSTITUTIONS[k].name)), state.activeAgreements.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, color: colors.inkSoft, fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 15 } }, "active agreements: ", state.activeAgreements.map((a) => `${a.turnsLeft} turns left`).join(" \xB7 "))), /* @__PURE__ */ React.createElement(PayoffMatrix, { payoff, predictedR, predictedU }), /* @__PURE__ */ React.createElement("div", { style: S.facilitatorPanel }, /* @__PURE__ */ React.createElement("div", { style: S.facilitatorTitle }, /* @__PURE__ */ React.createElement(CompassMark, null), /* @__PURE__ */ React.createElement("span", null, "Your move this turn")), /* @__PURE__ */ React.createElement("div", { style: S.facilitatorIntro }, "translation and information are cheap and shift voice without forcing a decision \xB7 trades and agreements put a real proposal on the table \xB7 building an institution is slow but permanent"), Object.entries(MOVES).map(([key, move]) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: S.moveBtnTitle }, /* @__PURE__ */ React.createElement("span", null, move.name), /* @__PURE__ */ React.createElement("span", { style: S.moveBtnCost }, move.cost.facilitatorEnergy, "\u26A1")),
        /* @__PURE__ */ React.createElement("div", { style: S.moveBtnBlurb }, move.blurb),
        !affordable && move.requires?.trust && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: colors.bad, marginTop: 4 } }, "Requires trust \u2265 ", move.requires.trust, " on both sides")
      );
    }), pickingInstitution && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12, padding: 12, background: "rgba(252, 232, 200, 0.45)", border: `2px dashed ${colors.facilitator}`, borderRadius: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 13, fontWeight: 700, color: colors.facilitatorDeep, marginBottom: 8, letterSpacing: "-0.01em" } }, "\u2726 Which institution to propose?"), Object.entries(INSTITUTIONS).map(([key, inst]) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: S.institutionPickName }, built && /* @__PURE__ */ React.createElement("span", { style: { color: colors.good } }, "\u2713"), /* @__PURE__ */ React.createElement("span", null, inst.name), /* @__PURE__ */ React.createElement("span", { style: { marginLeft: "auto", fontSize: 10, color: colors.facilitatorDeep, fontWeight: 600, fontFamily: "ui-monospace, 'SF Mono', Menlo, monospace", background: "rgba(181,108,58,0.12)", padding: "2px 6px", borderRadius: 10 } }, "tier ", inst.tier)),
        /* @__PURE__ */ React.createElement("div", { style: S.institutionPickBlurb }, inst.blurb),
        /* @__PURE__ */ React.createElement("div", { style: S.institutionPickReq }, built ? "\u2713 already built" : `requires trust \u2265 ${inst.requires?.trust || 0}${inst.requires?.institutions ? `, ${inst.requires.institutions}+ institutions built` : ""}`),
        /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: colors.facilitatorDeep, fontStyle: "italic", marginTop: 4, fontFamily: "Georgia, 'Times New Roman', serif" } }, inst.lineage)
      );
    })), previewDealMoveType && previewDeal.summary && /* @__PURE__ */ React.createElement("div", { style: S.dealCard, className: "fadein" }, /* @__PURE__ */ React.createElement("div", { style: S.dealTitle }, "\u2726 Proposed exchange"), /* @__PURE__ */ React.createElement("div", { style: S.dealLine }, previewDeal.summary), predictedR && predictedU && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, marginTop: 10, color: colors.inkSoft, lineHeight: 1.5, padding: "8px 10px", background: "rgba(255,255,255,0.5)", borderRadius: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 700, fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", color: colors.facilitatorDeep, display: "block", marginBottom: 4 } }, "likely outcome"), /* @__PURE__ */ React.createElement("strong", { style: { color: predictedR === "C" ? colors.good : colors.bad } }, "\u{1F33E} ", state.rural.name, " ", predictedR === "C" ? "cooperates" : "defects"), " \xB7 ", /* @__PURE__ */ React.createElement("strong", { style: { color: predictedU === "C" ? colors.good : colors.bad } }, "\u{1F3D9} ", state.urban.name, " ", predictedU === "C" ? "cooperates" : "defects"))), /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    )), /* @__PURE__ */ React.createElement("div", { style: S.logSection }, /* @__PURE__ */ React.createElement("div", { style: S.logTitle }, "Recent turns"), recentLog.map((entry, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
      ...S.logItem,
      color: entry.tone === "good" ? colors.good : entry.tone === "bad" ? colors.bad : colors.ink
    } }, /* @__PURE__ */ React.createElement("span", { style: S.logTurn }, "t", entry.turn), entry.text))), /* @__PURE__ */ React.createElement(CopyLogButton, { state }));
  }
