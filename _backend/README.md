...
- Old/historical material → see `_archive/` (Squarespace export, legacy artifacts)
- Posts in progress → see `_drafts/` (Jekyll picks these up when you run `jekyll serve --drafts`)
- Anything ready to publish → top-level pages or `_posts/`
